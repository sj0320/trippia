...
CREATE TABLE diary_comment (
    ...
    content TEXT,
    created_at DATETIME,
    CONSTRAINT fk_diary_comment_user FOREIGN KEY (user_id) REFERENCES user(user_id) ON DELETE CASCADE,
    CONSTRAINT fk_diary_comment_diary FOREIGN KEY (diary_id) REFERENCES diary(diary_id) ON DELETE CASCADE
);
...
CREATE TABLE diary_place (
    ...
    CONSTRAINT fk_diary_place_diary FOREIGN KEY (diary_id) REFERENCES diary(diary_id) ON DELETE CASCADE,
...
CREATE TABLE likes (
    ...
    user_id BIGINT,
    created_at DATETIME,
    CONSTRAINT fk_likes_diary FOREIGN KEY (post_id) REFERENCES diary(diary_id) ON DELETE CASCADE,
...
CREATE TABLE diary_theme (
    ...
    CONSTRAINT fk_diary_theme_diary FOREIGN KEY (diary_id) REFERENCES diary(diary_id) ON DELETE CASCADE
);
...
CREATE TABLE companion_post (
    ...
    created_at DATETIME,
    updated_at DATETIME,
    CONSTRAINT fk_companion_post_user FOREIGN KEY (user_id) REFERENCES user(user_id) ON DELETE CASCADE,
...
CREATE TABLE companion_post_comment (
    ...
    created_at DATETIME,
    updated_at DATETIME,
    CONSTRAINT fk_companion_post_comment_post FOREIGN KEY (post_id) REFERENCES companion_post(post_id) ON DELETE CASCADE,
    CONSTRAINT fk_companion_post_comment_user FOREIGN KEY (user_id) REFERENCES user(user_id) ON DELETE CASCADE
);
...
CREATE TABLE plan_participant (
    ...
    role VARCHAR(255),
    status VARCHAR(255),
    CONSTRAINT fk_plan_participant_user FOREIGN KEY (user_id) REFERENCES user(user_id) ON DELETE CASCADE,
...
CREATE TABLE plan_city (
    ...
    plan_id BIGINT,
    city_id BIGINT,
    CONSTRAINT fk_plan_city_plan FOREIGN KEY (plan_id) REFERENCES plan(plan_id) ON DELETE CASCADE,
...
CREATE TABLE schedule (
    ...
    plan_id BIGINT,
    date DATE,
    CONSTRAINT fk_schedule_plan FOREIGN KEY (plan_id) REFERENCES plan(plan_id) ON DELETE CASCADE
);
...
CREATE TABLE schedule_item (
    ...
    CONSTRAINT fk_schedule_item_schedule FOREIGN KEY (schedule_id) REFERENCES schedule(schedule_id) ON DELETE CASCADE
);
...
CREATE TABLE memo (
    ...
    content VARCHAR(255),
    created_at DATETIME,
    CONSTRAINT fk_memo_schedule_item FOREIGN KEY (schedule_item_id) REFERENCES schedule_item(schedule_item_id) ON DELETE CASCADE
);
...
CREATE TABLE schedule_place (
    ...
    CONSTRAINT fk_schedule_place_schedule_item FOREIGN KEY (schedule_item_id) REFERENCES schedule_item(schedule_item_id) ON DELETE CASCADE
);