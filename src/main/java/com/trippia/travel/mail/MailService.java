...
public class MailService {
    private static final String REGISTER_EMAIL_TEMPLATE = "sign-up-email.html";
    private static final String FIND_PASSWORD_EMAIL_TEMPLATE = "find-password-email.html";
