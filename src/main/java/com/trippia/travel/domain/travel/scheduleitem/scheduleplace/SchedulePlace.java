...
public class SchedulePlace extends ScheduleItem {
    ...
    @Builder
    private SchedulePlace(Schedule schedule, String googleMapId, String name, String address,
                          double latitude, double longitude, String category, Integer sequence) {
